...
public class ColorClassifyByImageFileRequest extends CallApiByImageFileBaseRequest<ColorAnalysisResponse> {
    ...
    public ColorClassifyByImageFileRequest(String loc) {
        super("color", "_0000072", loc);
    }

    public ColorClassifyByImageFileRequest(SubType subType, Granularity granularity, ColorReturnType returnType, File imageFile, String loc) {
        this(loc);
    ...
    public ColorClassifyByImageFileRequest(String serviceType, String serviceId, String loc) {
        super(serviceType, serviceId, loc);
    }

    public ColorClassifyByImageFileRequest(String serviceType, String serviceId, File imageFile, String loc) {
