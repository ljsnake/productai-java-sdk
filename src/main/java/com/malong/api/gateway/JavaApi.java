...
public class JavaApi {
    final static int SSF_SIGNATURE_LEN = 32;
    final static String SSF_CLIENT_API = "https://api.productai.cn";
    final static String SSF_CLIENT_VERSION = "1";
    ...
    public static String delete_image_by_file(Map<String, String> form) throws Exception {
        String request_method = "post";
